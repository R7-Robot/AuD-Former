...
class AUDFORMERModel(nn.Module):
    def __init__(self, hyp_params):
        ...
        self.orig_d_m19, self.orig_d_m20, self.orig_d_m21 = hyp_params.orig_d_m19, hyp_params.orig_d_m20, hyp_params.orig_d_m21
        self.d_m = 30
    ...
    def get_network(self, self_type='l', layers=-1):
        if self_type in ['m1_all','m2_all','m3_all','self','policy']:
    ...
    def forward(self,m1,m2,m3,m4,m5,m6,m7,m8,m9,m10,m11,m12,m13,m14,m15,m16,m17,m18,m19,m20,m21):
        ...
        proj_all = torch.cat([proj_1,proj_2,proj_3] , dim = 0)
        ...
        last_hs1 = torch.cat([p1_with_all,p2_with_all,p3_with_all] , dim = 0)
