...
class HUSFORMERModel(nn.Module):
    def __init__(self, hyp_params):
        ...
        self.orig_d_m13, self.orig_d_m14 = hyp_params.orig_d_m13, hyp_params.orig_d_m14
        self.orig_d_m15, self.orig_d_m16, self.orig_d_m17, self.orig_d_m18 = hyp_params.orig_d_m15, hyp_params.orig_d_m16, hyp_params.orig_d_m17, hyp_params.orig_d_m18
        self.orig_d_m19, self.orig_d_m20, self.orig_d_m21, self.orig_d_m22 = hyp_params.orig_d_m19, hyp_params.orig_d_m20, hyp_params.orig_d_m21, hyp_params.orig_d_m22
        self.orig_d_m23, self.orig_d_m24, self.orig_d_m25, self.orig_d_m26 = hyp_params.orig_d_m23, hyp_params.orig_d_m24, hyp_params.orig_d_m25, hyp_params.orig_d_m26
        self.orig_d_m27, self.orig_d_m28 = hyp_params.orig_d_m27, hyp_params.orig_d_m28
        self.orig_d_m29, self.orig_d_m30, self.orig_d_m31, self.orig_d_m32 = hyp_params.orig_d_m29, hyp_params.orig_d_m30, hyp_params.orig_d_m31, hyp_params.orig_d_m32
        self.orig_d_m33, self.orig_d_m34, self.orig_d_m35 = hyp_params.orig_d_m33, hyp_params.orig_d_m34, hyp_params.orig_d_m35
        self.d_m = 30
        ...
        self.channels = (hyp_params.m1_len+hyp_params.m2_len+hyp_params.m3_len+hyp_params.m4_len+hyp_params.m5_len+hyp_params.m6_len+hyp_params.m7_len +
                        ...
                        hyp_params.m29_len+ hyp_params.m30_len+ hyp_params.m31_len+ hyp_params.m32_len+ hyp_params.m33_len+ hyp_params.m34_len+ hyp_params.m35_len  )
        ...
        self.channels_5 = hyp_params.m29_len+ hyp_params.m30_len+ hyp_params.m31_len+ hyp_params.m32_len+ hyp_params.m33_len+ hyp_params.m34_len+ hyp_params.m35_len
        ...
        self.proj_m29 = nn.Conv1d(self.orig_d_m29, self.d_m, kernel_size=1, padding=0, bias=False)
        self.proj_m30 = nn.Conv1d(self.orig_d_m30, self.d_m, kernel_size=1, padding=0, bias=False)
        self.proj_m31 = nn.Conv1d(self.orig_d_m31, self.d_m, kernel_size=1, padding=0, bias=False)
        self.proj_m32 = nn.Conv1d(self.orig_d_m32, self.d_m, kernel_size=1, padding=0, bias=False)
        self.proj_m33 = nn.Conv1d(self.orig_d_m33, self.d_m, kernel_size=1, padding=0, bias=False)
        self.proj_m34 = nn.Conv1d(self.orig_d_m34, self.d_m, kernel_size=1, padding=0, bias=False)
        self.proj_m35 = nn.Conv1d(self.orig_d_m35, self.d_m, kernel_size=1, padding=0, bias=False)
    ...
    def get_network(self, self_type='l', layers=-1):
        if self_type in ['m1_all','m2_all','m3_all','m4_all','m5_all','self','policy']:
    ...
    def forward(self,m1,m2,m3,m4,m5,m6,m7,m8,m9,m10,m11,m12,m13,m14,m15,m16,m17,m18,m19,m20,m21,m22,m23,m24,m25,m26,m27,m28,m29,m30,m31,m32,m33,m34,m35):        
        ...
        m_29 = m29.transpose(1, 2)
        m_30 = m30.transpose(1, 2)
        m_31 = m31.transpose(1, 2)
        m_32 = m32.transpose(1, 2)
        m_33 = m33.transpose(1, 2)
        m_34 = m34.transpose(1, 2)
        m_35 = m35.transpose(1, 2)
        # Project features
        ...
        proj_x_m29 = m_29 if self.orig_d_m29 == self.d_m else self.proj_m29(m_29)
        proj_x_m30 = m_30 if self.orig_d_m30 == self.d_m else self.proj_m30(m_30)
        proj_x_m31 = m_31 if self.orig_d_m31 == self.d_m else self.proj_m31(m_31)
        proj_x_m32 = m_32 if self.orig_d_m32 == self.d_m else self.proj_m32(m_32)
        proj_x_m33 = m_33 if self.orig_d_m33 == self.d_m else self.proj_m33(m_33)
        proj_x_m34 = m_34 if self.orig_d_m34 == self.d_m else self.proj_m34(m_34)
        proj_x_m35 = m_35 if self.orig_d_m35 == self.d_m else self.proj_m35(m_35)
        ...
        proj_x_m29 = proj_x_m29.permute(2, 0, 1)
        proj_x_m30 = proj_x_m30.permute(2, 0, 1)
        proj_x_m31 = proj_x_m31.permute(2, 0, 1)
        proj_x_m32 = proj_x_m32.permute(2, 0, 1)
        proj_x_m33 = proj_x_m33.permute(2, 0, 1)
        proj_x_m34 = proj_x_m34.permute(2, 0, 1)
        proj_x_m35 = proj_x_m35.permute(2, 0, 1)
        ...
        proj_5_ = torch.cat([proj_x_m29 , proj_x_m30 , proj_x_m31 , proj_x_m32, proj_x_m33 , proj_x_m34 , proj_x_m35] , dim = 0)

        proj_1 = self.trans_self(proj_1_)
        proj_2 = self.trans_self(proj_2_)
        proj_3 = self.trans_self(proj_3_)
        proj_4 = self.trans_self(proj_4_)
        proj_5 = self.trans_self(proj_5_)
        proj_all = torch.cat([proj_1,proj_2,proj_3,proj_4,proj_5] , dim = 0)
        ...
        p5_with_all = self.trans_m5_all(proj_5,proj_all,proj_all)
        last_hs1 = torch.cat([p1_with_all,p2_with_all,p3_with_all,p4_with_all,p5_with_all] , dim = 0)
